    ...
    <div class="container footer-grid">
      <div>
        ...
        <div class="social-links">
          ...
          <a href="https://g.page/r/CW8teVGp989YEAE/review" target="_blank" rel="noopener" aria-label="לפרגן בגוגל">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2l2.9 6.26L21.5 9l-4.9 4.63L17.8 21 12 17.6 6.2 21l1.2-7.37L2.5 9l6.6-.74L12 2Z"/></svg>
          </a>
        </div>
      </div>
      <div>
...
massage_body = f"""  <section class="hero" style="min-height:44vh;">
  ...
  <section class="container">
    ...
    <div class="price-grid">
      ...
      <div class="price-card"><span class="amount">1,500 ₪</span><span class="label">כרטיסייה ל-5 טיפולים</span><span class="per">לפי 300 ₪ לטיפול</span></div>
      <div class="price-card"><span class="amount">2,800 ₪</span><span class="label">כרטיסייה ל-10 טיפולים</span><span class="per">לפי 280 ₪ לטיפול</span></div>
    </div>
...
breathwork_body = f"""  <section class="hero" style="min-height:44vh;">
  ...
  <section class="container">
    ...
    <div class="price-grid">
      ...
      <div class="price-card"><span class="amount">1,500 ₪</span><span class="label">כרטיסייה ל-5 סשנים</span><span class="per">לפי 300 ₪ לסשן</span></div>
      <div class="price-card"><span class="amount">2,800 ₪</span><span class="label">כרטיסייה ל-10 סשנים</span><span class="per">לפי 280 ₪ לסשן</span></div>
    </div>
    ...
    <div class="price-grid">
      ...
      <div class="price-card"><span class="amount">400 ₪</span><span class="label">כרטיסייה ל-5 טבילות</span><span class="per">לפי 80 ₪ לטבילה</span></div>
      <div class="price-card"><span class="amount">600 ₪</span><span class="label">כרטיסייה ל-10 טבילות</span><span class="per">לפי 60 ₪ לטבילה</span></div>
    </div>
  </section>
