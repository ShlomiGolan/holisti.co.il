    ...
    <div class="container nav-row">
      ...
      <nav>
        ...
        {nav_html(current_file)}
          <li><a href="contact.html" class="nav-cta">קביעת תור</a></li>
        </ul>
      </nav>
...
index_body = f"""  <section class="hero">
  ...
  <section class="container">
    ...
    <p style="font-family: var(--font-display); font-size:1.3rem; color:var(--ink);">מה הגוף שלך צריך?</p>
  </section>

  <section class="container">
    <span class="section-label">שני מסלולים</span>
    <h2>בחרו את הדרך שלכם</h2>
    <div class="track-grid">
      <div class="track-card">
        <span class="tag">מגע</span>
        <h3>עיסוי משולב</h3>
        <p>להרגיש קצת יותר בבית בתוך הגוף שלך.</p>
        <a href="massage.html" class="btn btn-outline">לעמוד המלא</a>
      </div>
      <div class="track-card">
        <span class="tag">נשימה וחשיפה לקור</span>
        <h3>אמבטיית קרח</h3>
        <p>להתעורר מחדש לחיים.</p>
...
def service_page(hero_img, hero_alt, h1_placeholder_label):
  ...
  <section class="container cta-section" style="text-align:center;">
    <a href="contact.html" class="btn btn-primary">לשליחת הודעה</a>
  </section>
"""
...
MASSAGE_FAQ_PAIRS = [
    ...
    ("האם אפשר לשלב עם נשימה וחשיפה לקור?", "כמובן, מדובר בשילוב מנצח!"),
    ("למי זה מתאים?", "עיסוי משולב יכול לסייע בהפחתת כאב וסטרס, ובשיפור התנועה במגוון מצבים, בהם כאבי גב, כאבי צוואר וכתפיים, כאבי מפרקים, עומס שרירי, כאבים בעקבות פציעות ספורט ומצבים אורתופדיים שונים. כל טיפול מותאם למצב הגוף באותו יום, ומשלב טכניקות שונות בהתאם לצורך. מי שסובל מכאב או מתח כרוני - לא רק בגב, בצוואר או בכתפיים. גם אנשים בתקופות לחוצות שמרגישים \"מנותקים\" מהגוף שלהם, מי שמחפש טיפול לא-פולשני לצד טיפולים רפואיים אחרים, ומי שרוצה להעניק לעצמו זמן קבוע של ריפוי ושקט."),
...
massage_body = f"""  <section class="hero" style="min-height:44vh;">
    ...
    <div class="container hero-content">
      <h1>עיסוי משולב לכאבים ומתח בגוף</h1>
      <p style="max-width:50ch;">קיבוץ משמרות, פרדס חנה-כרכור</p>
    </div>
  </section>
  ...
  <section class="container">
    ...
    <div class="price-grid">
      <div class="price-card"><span class="amount">330 ₪</span><span class="label">טיפול יחיד</span></div>
      <div class="price-card"><span class="amount">1,500 ₪</span><span class="label">כרטיסייה ל-5 טיפולים</span></div>
      <div class="price-card"><span class="amount">2,800 ₪</span><span class="label">כרטיסייה ל-10 טיפולים</span></div>
    </div>
  ...
  <section class="container">
    ...
    <div class="faq-list">
      <details class="faq-item">
        <summary>למה עיסוי משולב?</summary>
        <p>לפעמים עיסוי רקמות עמוק הוא בדיוק מה שהגוף צריך, ולפעמים דווקא מגע עדין יותר. זה תלוי באדם, בסיבה שבגללה הגיע לטיפול, במה שהגוף מספר באותו יום, ואפילו במה שקורה תוך כדי הטיפול. לכן אין שני טיפולים זהים. כל טיפול נבנה מחדש, בהתאם למה שנכון לאותו רגע. הכלים בעיסוי המשולב מותאמים לתחזוקה, וגם לטיפול בכאב. טכניקות כמו טריגר פוינטס יכולות לעזור בשחרור שרירים תפוסים.</p>
      </details>
      <details class="faq-item">
        <summary>האם הטיפול כואב?</summary>
        <p>הרבה אנשים מגיעים בגלל כאב, ועם זה אנחנו עובדים. לרוב נתמקד גם באזורים תפוסים או רגישים, אבל לא צריך לסבול כדי להשתפר. יש מגוון רחב של טכניקות, והמטרה היא למצוא את הדרך שתאפשר לגוף להשתחרר. לפעמים זה כמעט לא מורגש, ולפעמים יש אי-נוחות מסוימת - אבל כזו שמרגישה "נכונה", ולא כמו סבל.</p>
      </details>
      <details class="faq-item">
        <summary>האם צריך להגיע רק כשכואב?</summary>
        <p>ממש לא. מומלץ להגיע ל"תחזוקה" - להפחית עומס, לשמור על תנועתיות טובה, ולאפשר לעצמך רגע שקט. יחד עם פעילות גופנית, זו השקעה פנסיונית מצוינת לטווח הארוך.</p>
      </details>
      <details class="faq-item">
        <summary>כמה זמן נמשך טיפול?</summary>
        <p>שעה. יש אפשרות לקבוע מראש גם טיפול של 75 או 90 דקות, בתוספת תשלום.</p>
      </details>
      <details class="faq-item">
        <summary>האם צריך הכנה מיוחדת לפני ההגעה?</summary>
        <p>לא, אבל מומלץ לפנות קצת יותר זמן ולא לאכול ארוחה כבדה לפני הטיפול. העבודה היא עם חמאת שיאה שלרוב נספגת מהר, אבל כדאי לבחור בגדים שלא נורא להכתים.</p>
      </details>
      <details class="faq-item">
        <summary>כל כמה זמן מומלץ להגיע לטיפול?</summary>
        <p>לכל אחד מתאים מרווח אחר. אם בוחרים בסדרה של טיפולים, כדאי לעשות את הטיפול השני בטווח של 7-10 ימים מהטיפול הראשון, ואז להחליט אם להמשיך בתדירות של פעם בשבוע, פעם בשבועיים, פעם בשלושה חודשים, או רק כשצריך.</p>
      </details>
      <details class="faq-item">
        <summary>מעולם לא עשיתי עיסוי - זה מתאים גם לי?</summary>
        <p>איזה כיף לנסות משהו בפעם הראשונה! אבל חוסר הוודאות לפעמים קצת מלחיץ - כמובן שמתאים, ואני מבטיח להסביר הכל כדי שהחוויה תהיה טובה ונינוחה.</p>
      </details>
      <details class="faq-item">
        <summary>האם אפשר לשלב עם נשימה וחשיפה לקור?</summary>
        <p>כמובן, מדובר בשילוב מנצח!</p>
      </details>
      <details class="faq-item">
        <summary>למי זה מתאים?</summary>
        <p>עיסוי משולב יכול לסייע בהפחתת כאב וסטרס, ובשיפור התנועה במגוון מצבים, בהם כאבי גב, כאבי צוואר וכתפיים, כאבי מפרקים, עומס שרירי, כאבים בעקבות פציעות ספורט ומצבים אורתופדיים שונים. כל טיפול מותאם למצב הגוף באותו יום, ומשלב טכניקות שונות בהתאם לצורך.</p>
        <p>מי שסובל מכאב או מתח כרוני - לא רק בגב, בצוואר או בכתפיים. גם אנשים בתקופות לחוצות שמרגישים "מנותקים" מהגוף שלהם, מי שמחפש טיפול לא-פולשני לצד טיפולים רפואיים אחרים, ומי שרוצה להעניק לעצמו זמן קבוע של ריפוי ושקט.</p>
      </details>
      <details class="faq-item">
        <summary>אילו הסמכות יש לך בתחום?</summary>
        <p>אני מוסמך בעיסוי שוודי, עיסוי רקמות עמוק ועיסוי באבנים חמות, וכן בתרפיה מנואלית ותנועה, עיסוי רפואי בכיר, וטיפול אורתופדי הוליסטי. השילוב הזה מאפשר להתאים את הטיפול בדיוק למה שהגוף צריך בכל פגישה. במהלך לימודי הנטורופתיה הוסמכתי גם כמטפל בארומתרפיה ומטפל בכיר ברפלקסולוגיה.</p>
      </details>
    </div>
  </section>
...
BREATHWORK_FAQ_PAIRS = [
    ...
    ("האם זה בטוח לכולם?", "הטבילה באמבטיית קרח אינה מתאימה לאנשים עם מחלות לב, יתר לחץ דם, או לנשים בהריון. אם יש לכם מצב בריאותי שאתם לא בטוחים לגביו, מומלץ להתייעץ עם רופא לפני ההגעה."),
    ...
    ("אפשר לשלב עם עיסוי משולב?", "כמובן, מדובר בשילוב מנצח!"),
...
breathwork_body = f"""  <section class="hero" style="min-height:44vh;">
  ...
  <section class="container">
    ...
    <p>מעבר למה שאנחנו כבר יודעים מהמחקר על חשיפה לקור - השפעה על ההתאוששות מאימונים, על שיפור מערכת החיסון, דלקתיות, ריכוז ועל תהליכים נוספים בגוף - מה שמסקרן אותי באמת הוא משהו אחר. הבחירה להישאר באי-הנוחות.</p>
  ...
  <section class="container">
    ...
    <h2>עלות המפגש</h2>
    <div class="price-grid">
      <div class="price-card"><span class="amount">330 ₪</span><span class="label">סשן אישי (כשעה)</span></div>
      <div class="price-card"><span class="amount">1,500 ₪</span><span class="label">כרטיסייה ל-5 סשנים</span></div>
      <div class="price-card"><span class="amount">2,800 ₪</span><span class="label">כרטיסייה ל-10 סשנים</span></div>
    </div>
    ...
    <div class="price-grid">
      <div class="price-card"><span class="amount">100 ₪</span><span class="label">טבילה בודדת</span></div>
      <div class="price-card"><span class="amount">400 ₪</span><span class="label">כרטיסייה ל-5 טבילות</span></div>
      <div class="price-card"><span class="amount">600 ₪</span><span class="label">כרטיסייה ל-10 טבילות</span></div>
    </div>
  </section>
...
FILES = {
    "index.html": page_shell("בית", "index.html", index_body, description="עיסוי משולב, נשימה וחשיפה לקור עם שלומי גולן - קיבוץ משמרות, פרדס חנה-כרכור. הכל מתחיל בגוף."),
