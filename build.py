...
def footer():
    ...
    <div class="container footer-grid">
      <div>
        <h4>שלומי גולן</h4>
        <p style="max-width: 32ch;">קליניקה לעיסוי משולב, נשימה וחשיפה לקור - קיבוץ משמרות, פרדס חנה-כרכור.</p>
        <div class="social-links">
          ...
          <a href="https://waze.com/ul/hsvbbu41y6" target="_blank" rel="noopener" aria-label="ניווט בוויז">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C7.58 2 4 5.58 4 10c0 5.25 6.72 11.19 7.11 11.52.26.22.62.22.88 0C13.28 21.19 20 15.25 20 10c0-4.42-3.58-8-8-8Zm0 10.5A2.5 2.5 0 1 1 12 7.5a2.5 2.5 0 0 1 0 5Z"/></svg>
          </a>
...
{footer()}
  ...
  <button class="a11y-float" id="a11yToggle" aria-label="אפשרויות נגישות" aria-expanded="false" aria-controls="a11yPanel">Aa</button>
  <div class="a11y-panel" id="a11yPanel" role="region" aria-label="אפשרויות נגישות">
    <h4>גודל טקסט</h4>
    <button type="button" id="a11yTextInc">הגדלת טקסט (A+)</button>
    <button type="button" id="a11yTextDec">הקטנת טקסט (A-)</button>
    <button type="button" id="a11yTextReset">איפוס גודל טקסט</button>
    <h4>תנועה</h4>
    <button type="button" id="a11yMotion" aria-pressed="false">עצירת אנימציות</button>
  </div>
...
about_body = f"""  <section class="hero" style="min-height:40vh;">
  ...
  <section class="container">
    <img src="assets/shlomi-wide.png" alt="שלומי גולן ליד אמבטיית הקרח" class="about-photo">
    <p style="margin:0 0 1.5rem; font-family: var(--font-display); font-size:1.3rem;">שלומי גולן</p>
...
accessibility_body = f"""  <section class="container" style="padding-top:3rem;">
    ...
    <ul style="color:var(--ink-soft); padding-inline-start:1.3rem; margin:0 0 1.5rem;">
      <li>תפריט נגישות (הכפתור "Aa" בפינת המסך) עם אפשרות להגדלת טקסט ולעצירת אנימציות</li>
      <li>ניגודיות צבעים תואמת תקן (יחס 4.5:1 לפחות)</li>
...
privacy_body = f"""  <section class="container" style="padding-top:3rem;">
    ...
    <p>האתר משתמש בשירות Cloudflare Web Analytics למדידת תנועה כללית ואנונימית בלבד (כגון מספר כניסות ודפים נצפים). השירות אינו משתמש בעוגיות (cookies) ואינו אוסף מידע מזהה אישי.</p>
    <h3>הצהרת בריאות</h3>
...
FILES["76237c8d208641b1964739080c67370f.txt"] = "76237c8d208641b1964739080c67370f\n"
